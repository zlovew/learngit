...
public interface NetConstant {
    ...
    String HOME_LIST_PATH = "http://api.huogou.com/product/list?orderFlag=20&cid=0&bid=0&app=huogou&perpage=16&channel=360market&page=1&zgid=99000646343428&os=android&limit=all&version=2.0.4";
}
